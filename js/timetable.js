...
$(function () {
    ...
    var renderedFirst = Mustache.render(template, { table: firstDayTable, header: "11/22 (金)" });
    var renderedSecond = Mustache.render(template, { table: secondDayTable, header: "11/23 (土)" });
    var renderedThird = Mustache.render(template, { table: thirdDayTable, header: "11/24 (日)" });
